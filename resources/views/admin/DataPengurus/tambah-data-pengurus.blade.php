            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        <h1 class="h3 mb-4 text-gray-800 text-center">Tambah Data Pengurus SBGTS-GSBI PT. Victory Chingluh
                            Indonesia
                        </h1>

                        <div class="card">
                            <div class="cardbody">
                                <form action="/insert-data-pengurus" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        <label for="exampleInputEmail1" class="form-label">Genderi</label>
