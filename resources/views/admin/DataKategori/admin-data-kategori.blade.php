            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        <h1 class="h3 mb-4 text-gray-800 text-center">Data Kategori SBGTS-GSBI PT. Victory Chingluh Indonesia
                        </h1>
                        <a href="{{ route('admin-tambah-data-kategori') }}" type="button" class="btn btn-primary">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    @php
                                        $no = 1;
                                    @endphp
                                    @foreach ($dataKategori as $index => $row)
                                        <tr>
                                            <th scope="row">{{ $index + $dataKategori->firstItem() }}</th>
                                            <td>{{ $row->nama }}</td>
                                            <td>
                                                <a href="{{ route('admin-tampil-data-kategori', $row->id) }}"
                                                    ...
                                                    <script>
                                                        function deleteData(id) {
                                                            Swal.fire({
                                                                ...
                                                                if (result.value) {
                                                                    window.location.href = "/hapus-data-kategori/" + id + "hapusDataKategori";
                                                                }
                                                            });
                                                        }
                                                    </script>
                                                    <!-- Akhir Validasi Sweet Alert 2 Hapus -->
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
