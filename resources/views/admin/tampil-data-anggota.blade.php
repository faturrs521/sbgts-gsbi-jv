                                ...
                                <form action="/ubah-data-anggota/{{ $ubah->id }}" method="POST"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" name="nik" class="form-control" id="exampleInputEmail1"
                                            aria-describedby="emailHelp" value="{{ $ubah->nik }}">
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleInputEmail1" class="form-label">Nama Lengkap</label>
                                        <input type="text" name="nama" class="form-control" id="exampleInputEmail1"
                                            aria-describedby="emailHelp" value="{{ $ubah->nama }}">
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="kodedept" class="form-control" id="exampleInputEmail1"
                                            aria-describedby="emailHelp" value="{{ $ubah->kodedept }}">
                                    </div>
                                    <div class="mb-3">
